  ...
  const benefitSlides = [
    {
      ...
      description:
        "Join 5,000+ professionals who transformed their careers. Average salary uplift: ₹8-12 LPA.",
    ...
    },
    {
      ...
      description:
        "Learn directly from Microsoft Certified Trainers with 10+ years industry experience.",
    ...
    },
    {
      ...
      description:
        "Structured path from Systems Admin to Cloud Architect in 12 months.",
        ...
        <div className="text-center mb-12">
          ...
          <div className="emotional-headline space-y-6 mb-12">
            ...
            <p className="text-xl text-slate-700 max-w-3xl mx-auto leading-relaxed">
              Stop dreaming about a better career. Start building it. Join
              India's most
              <span className="font-bold text-blue-700">
                {" "}
                intelligent Active Directory Infrastructure
              </span>{" "}
              that understands your ambitions.
            </p>
          </div>
                ...
                <div className="flex flex-col lg:flex-row items-center gap-8">
                  <div className="flex-1">
                    <div className="inline-flex items-center space-x-3 mb-6">
                      <div
                        className={`p-3 rounded-xl bg-gradient-to-r ${slide.gradient} shadow-lg`}
                      >
                        {slide.icon}
                      </div>
                      <div
                        className={`px-4 py-1.5 rounded-full bg-gradient-to-r ${slide.gradient}/10 border ${slide.gradient.replace("from-", "border-").replace(" to-", "/20")}`}
                      >
                        <span
                          className={`text-sm font-bold bg-gradient-to-r ${slide.gradient} bg-clip-text text-black`}
                        >
                    ...
                    <div
                      className={`text-xl font-bold bg-gradient-to-r ${slide.gradient} bg-clip-text text-transparent mb-6`}
                    >
                      {slide.subtitle}
                    </div>
                  ...
                  <div className="flex-1">
                    <div className="relative">
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${slide.gradient} rounded-3xl blur-xl opacity-30`}
                      ></div>
            ...
            <div className="bg-gradient-to-br from-white to-white/90 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-2xl">
              ...
              <div className="relative bg-gradient-to-r from-blue-50/50 to-cyan-50/50 rounded-2xl p-6 mb-8 border border-blue-100/50">
                ...
                <p className="text-slate-700 italic mb-4">
                  "This program didn't just teach me skills—it changed my
                  mindset. From ₹6 LPA to ₹18 LPA in 9 months. The emotional
                  support was as valuable as the technical training."
                </p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-3">
        ...
        <div className="text-center">
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-slate-900 to-slate-800 text-white px-6 py-3 rounded-full mb-6">
            <span className="font-bold">
              Your journey to ₹20 LPA starts with one decision
            </span>
          </div>
          <p className="text-lg text-slate-700 max-w-2xl mx-auto">
            Don't let uncertainty hold you back. Join a community of ambitious
            professionals who dared to dream bigger. Your future self will thank
            you.
          </p>
        </div>
        <div class="text-center">
          <h1 class="mb-4 mt-8 text-xl font-normal">
            Want More Information? Let's Go Through This Site
          </h1>
          <a
