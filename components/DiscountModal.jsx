...
const DiscountModal = ({ onCloseComplete }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      <div
        ref={cardRef}
        className="relative w-full max-w-[380px] sm:max-w-md bg-white rounded-[40px] shadow-[0_40px_80px_rgba(0,0,0,0.4)] overflow-hidden border border-white/20"
      >
        <div
          className="absolute top-0 left-0 h-1.5 bg-[#F39200] z-20 transition-all duration-1000 ease-linear"
        ...
        <div className="p-8  sm:p-5 text-center relative z-10 flex flex-col items-center">
         {/* <div className='flex flex-row justify-between items-center mb-4' style={{justifyContent: 'space-between', gap: '100px'}}> */}
          ...
          <div className="relative py-4 flex flex-col items-center">
            ...
            <p className="text-slate-400 font-black text-[9px] uppercase tracking-[0.3em] mt-3 opacity-80">
          ...
          <div className="my-6 py-3 px-6 bg-slate-900 rounded-2xl border border-slate-800 relative group overflow-hidden">
            ...
            <div className="flex flex-col items-center relative z-10">
              <span className="text-[8px] font-black text-slate-500 uppercase tracking-[0.4em] mb-1">
                Offer Expires In
              </span>
          ...
          <div className="grid grid-cols-3 gap-3 w-full mb-8">
            <div className="flex flex-col items-center p-3 bg-slate-50 rounded-2xl border border-slate-100">
              ...
              <span className="text-[7px] font-black text-slate-400 uppercase text-center leading-tight">
                Limited
                <br />
                Seats
              </span>
          ...
          <button
            ...
            className="w-full py-5 bg-[#005DAA] text-white rounded-2xl font-black text-sm shadow-[0_15px_30px_rgba(0,93,170,0.3)] hover:bg-slate-900 transition-all transform hover:-translate-y-1 flex items-center justify-center space-x-3 group border-none cursor-pointer"
          >
